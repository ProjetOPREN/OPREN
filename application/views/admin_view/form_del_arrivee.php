...
<div class="w3-main">
    ...
    <h1 class="w3-xxxlarge w3-text-light-blue"><b>Supprimer une Arrivee</b></h1>
    	<form action="<?php echo site_url('Administrateur/del_arrivee')?>" method="POST">
       		<div class="w3-section">
       			<label>Arrivee:</label>
       			<select class="w3-input w3-border" type="text" name="arrivee" required>
       				<?php foreach ($arrivee as $row) {
